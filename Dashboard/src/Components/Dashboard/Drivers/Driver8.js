...
import U_CR from './assets/U_CR.png';
          ...
          <Layout>
            <Content style={{ padding: '0 50px' }}>
              ...
              <div site-layout-content style={{ background: '#fff', padding: 48, minHeight: 580 }}>
                <h2>Aumento de costos de bienes vendidos</h2>
                <p>
                  El vender mucho, debe estar acompañado de márgenes racionales,
                  y si estos se empequeñecen, puede representar gran riesgo a la firma.
                </p>
                <img src={U_CR} alt="Driver 8" />
